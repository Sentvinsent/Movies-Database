...
document.getElementById('search-btn').addEventListener('click', _functions__WEBPACK_IMPORTED_MODULE_0__.searchMovies);
...
window.onscroll = function () {
  if (window.innerHeight + window.scrollY >= document.body.offsetHeight) {
    (0,_functions__WEBPACK_IMPORTED_MODULE_0__.loadMore)();
  }
};
})();
