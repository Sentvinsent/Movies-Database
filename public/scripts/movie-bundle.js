...
var tmdbBtn = document.getElementById('tmdb-btn');
var budgetEl = document.getElementById('budget');
var movieId = location.hash.substring(1);
...
function _initPage() {
  _initPage = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
    var movie, rating;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.next = 2;
          return (0,_requests__WEBPACK_IMPORTED_MODULE_0__.getMovieDetails)(movieId);
        case 2:
          movie = _context.sent;
          ...
          tmdbBtn.onclick = function () {
            return location.assign(movie.tmdbPage);
          };
          if (movie.budget) {
          ...
          document.getElementById("".concat(rating, "-stars")).checked = true;
        case 13:
        case "end":
          return _context.stop();
      }
