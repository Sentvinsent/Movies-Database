...
/* harmony export */   "loadMovies": () => (/* binding */ loadMovies),
...
var searchTxt = document.getElementById('search-input');
var topBtn = document.getElementById('top-btn');

//save loaded movies into the storage
var saveMovies = function saveMovies() {
...
var loadMovies = function loadMovies() {
  var moviesDataJSON = localStorage.getItem('moviesData');
  try {
    if (moviesDataJSON) {
...
function _searchMovies() {
  _searchMovies = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
    var searchData;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 11:
          ...
          (0,_views__WEBPACK_IMPORTED_MODULE_1__.noResError)(_context.t0.message);
        case 14:
        case "end":
...
var key = '5ea363cd1fe377e3ae1dcc973693a928';
...
function _search() {
  _search = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(page) {
    var word, searchUrl, response, res, toReturn;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          if (page === 1) {
          ...
          searchUrl = "".concat(baseUrl, "search/movie?api_key=").concat(key, "&query=").concat(word, "&page=").concat(page);
          _context.next = 5;
        ...
        case 10:
          ...
          toReturn = {
            data: res.results.filter(function (movie) {
...
function getMovieDetails(_x2) {
  return _getMovieDetails.apply(this, arguments);
}
function _getMovieDetails() {
  _getMovieDetails = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(id) {
    var URL, response, res;
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          URL = "".concat(baseUrl, "movie/").concat(id, "?api_key=").concat(key);
          _context2.prev = 1;
          _context2.next = 4;
          return fetch(URL);
        case 4:
        ...
        case 9:
          ...
          return _context2.abrupt("return", {
            ...
            tmdbPage: "https://www.themoviedb.org/movie/".concat(res.id)
          });
        case 13:
          _context2.prev = 13;
          _context2.t0 = _context2["catch"](1);
          throw new Error('Failed to get movie details: ', _context2.t0);
        case 16:
        case "end":
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "noResError": () => (/* binding */ noResError),
...
function generateMovieDom(movie) {
  ...
  var movieTxtDiv = document.createElement('div');
  ...
  viewMoreBtn.onclick = function () {
    return location.assign("movie.html#".concat(movie._id));
  };
...
function renderMovies(movies) {
  movies.forEach(function (movie) {
    var movieEl = generateMovieDom(movie);
...
(0,_functions__WEBPACK_IMPORTED_MODULE_0__.loadMovies)();
document.getElementById('search-btn').addEventListener('click', function () {
  (0,_functions__WEBPACK_IMPORTED_MODULE_0__.resetSearch)();
  (0,_functions__WEBPACK_IMPORTED_MODULE_0__.searchMovies)();
});
document.getElementById('reset-btn').addEventListener('click', _functions__WEBPACK_IMPORTED_MODULE_0__.resetSearch);
document.getElementById('search-input').addEventListener('keydown', function (e) {
  if (e.key === 'Enter') {
    (0,_functions__WEBPACK_IMPORTED_MODULE_0__.searchMovies)();
  }
});
document.getElementById('top-btn').addEventListener('click', _functions__WEBPACK_IMPORTED_MODULE_0__.scrollToTop);

//handler scroll to the bottom of the page
window.onscroll = _functions__WEBPACK_IMPORTED_MODULE_0__.handleScroll;
})();
